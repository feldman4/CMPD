...
var _user$project$Base$viewRemark = function (remark) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
...
var _user$project$Base$showWordbankWord = F2(
	function (word, model) {
		return A2(
...
var _user$project$Base$check = _elm_lang$core$Native_Platform.outgoingPort(
	'check',
	function (v) {
		return [
			v._0,
...
var _user$project$Base$send = _elm_lang$core$Native_Platform.outgoingPort(
	'send',
	function (v) {
		return v;
	});
var _user$project$Base$scrollTop = _elm_lang$core$Native_Platform.outgoingPort(
	'scrollTop',
	function (v) {
		return v;
	});
var _user$project$Base$newWordbank = _elm_lang$core$Native_Platform.incomingPort(
	'newWordbank',
	_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string));
var _user$project$Base$suggestions = _elm_lang$core$Native_Platform.incomingPort(
	'suggestions',
	_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string));
var _user$project$Base$remark = _elm_lang$core$Native_Platform.incomingPort(
	'remark',
	A2(
			...
			return A2(
				...
				function (retort) {
					return _elm_lang$core$Json_Decode$succeed(
						{insult: insult, retort: retort});
				});
		}));
var _user$project$Base$setEnemyImage = _elm_lang$core$Native_Platform.incomingPort('setEnemyImage', _elm_lang$core$Json_Decode$string);
var _user$project$Base$Model = F5(
	function (a, b, c, d, e) {
		return {wordbank: a, addInput: b, enemyImage: c, maxToDisplay: d, conversation: e};
	});
var _user$project$Base$Remark = F2(
	function (a, b) {
		return {insult: a, retort: b};
	});
var _user$project$Base$SetEnemyImage = function (a) {
	return {ctor: 'SetEnemyImage', _0: a};
};
var _user$project$Base$AddRemark = function (a) {
	return {ctor: 'AddRemark', _0: a};
};
var _user$project$Base$EnterInput = {ctor: 'EnterInput'};
var _user$project$Base$Suggest = function (a) {
	return {ctor: 'Suggest', _0: a};
};
var _user$project$Base$AskSuggestions = function (a) {
	...
	function (message, model) {
		...
		while (true) {
			...
			switch (_p0.ctor) {
				...
				case 'UpdateAddInput':
					var _p1 = _p0._0;
					var _v1 = _user$project$Base$AskSuggestions(_p1),
					...
					if (_p4.ctor === 'Just') {
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{addInput: ''}),
							_1: _user$project$Base$send(_p4._0)
						};
					} else {
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
				...
				case 'AddRemark':
					return {
						...
						_1: _user$project$Base$scrollTop('#output')
					};
				default:
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
...
var _user$project$Base$UpdateAddInput = function (a) {
	return {ctor: 'UpdateAddInput', _0: a};
};
var _user$project$Base$UpdateWordbank = function (a) {
	return {ctor: 'UpdateWordbank', _0: a};
};
var _user$project$Base$NewWordbank = function (a) {
	return {ctor: 'NewWordbank', _0: a};
};
var _user$project$Base$init = F3(
	function (words, enemyImage, maxToDisplay) {
		...
		return A2(
			_user$project$Base$update,
			_user$project$Base$NewWordbank(words),
			model);
	});
var _user$project$Base$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Base$suggestions(_user$project$Base$Suggest),
				_user$project$Base$newWordbank(_user$project$Base$NewWordbank),
				_user$project$Base$remark(_user$project$Base$AddRemark),
				_user$project$Base$setEnemyImage(_user$project$Base$SetEnemyImage)
			]));
};
var _user$project$Base$NoOp = {ctor: 'NoOp'};
var _user$project$Base$onEnter = function (msg) {
	var tagger = function (code) {
		return _elm_lang$core$Native_Utils.eq(code, 13) ? msg : _user$project$Base$NoOp;
	};
	return A2(
		_elm_lang$html$Html_Events$on,
		'keydown',
...
var _user$project$Base$view = function (model) {
	var output = A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A2(_elm_lang$core$List$map, _user$project$Base$viewRemark, model.conversation))
			]));
	var enemy = A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Events$onInput(_user$project$Base$UpdateAddInput),
						_user$project$Base$onEnter(_user$project$Base$EnterInput),
	...
	var wordbank = A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$Base$UpdateWordbank,
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[enemy, output, addInput, wordbank]));
};
var _user$project$Base$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: A3(
				_user$project$Base$init,
				_elm_lang$core$Native_List.fromArray(
					[]),
				'',
				30),
...
var Elm = {};
Elm['Base'] = Elm['Base'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Base'], 'Base', typeof _user$project$Base$main === 'undefined' ? null : _user$project$Base$main);
