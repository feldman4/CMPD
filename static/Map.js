...
var _user$project$Map_Types$Map = F3(
	function (a, b, c) {
		return {image: a, name: b, places: c};
	});
var _user$project$Map_Types$Place = F4(
	function (a, b, c, d) {
		return {x: a, y: b, label: c, key: d};
	});
...
var _user$project$Menu_Menu$init = F2(
	function (tiles, id) {
		return {tiles: tiles, lastKey: 0, id: id, active: true};
	});
...
var _user$project$Map_Map$testMap = {image: 'static/images/islands.png', name: 'test', places: _user$project$Map_Map$testPlaces};
