...
var _user$project$Bar$defaultSliderClasses = _elm_lang$core$Native_List.fromArray(
	['bar-slider']);
var _user$project$Bar$defaultSliderAttributes = _elm_lang$core$Native_List.fromArray(
	[]);
var _user$project$Bar$defaultBoxClasses = _elm_lang$core$Native_List.fromArray(
	['bar-box']);
var _user$project$Bar$defaultBoxAttributes = _elm_lang$core$Native_List.fromArray(
	[]);
var _user$project$Bar$view = function (model) {
	var sliderClass = _elm_lang$html$Html_Attributes$class(
		A2(
			_elm_lang$core$String$join,
			' ',
			A2(_elm_lang$core$Basics_ops['++'], _user$project$Bar$defaultSliderClasses, model.sliderClasses)));
	var boxClass = _elm_lang$html$Html_Attributes$class(
		A2(
			_elm_lang$core$String$join,
			' ',
			A2(_elm_lang$core$Basics_ops['++'], _user$project$Bar$defaultBoxClasses, model.boxClasses)));
	var progress = A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(
			A2(_mgold$elm_animation$Animation$animate, model.clock, model.animation) * 100),
		'%');
	var shape = function () {
		var _p0 = model.horizontal;
		if (_p0 === true) {
			return _elm_lang$core$Native_List.fromArray(
				[
					{ctor: '_Tuple2', _0: 'width', _1: progress},
			...
			return _elm_lang$core$Native_List.fromArray(
				[
					...
					{ctor: '_Tuple2', _0: 'height', _1: progress}
				]);
		}
	}();
	return A2(
		...
		A2(
			_elm_lang$core$Basics_ops['++'],
			_user$project$Bar$defaultBoxAttributes,
			A2(
				_elm_lang$core$Basics_ops['++'],
				model.boxAttributes,
				_elm_lang$core$Native_List.fromArray(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					_user$project$Bar$defaultSliderAttributes,
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$style(shape)
							]),
						A2(
							_elm_lang$core$Basics_ops['++'],
...
var _user$project$Bar$update = F2(
	function (msg, model) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'Value':
				...
				return _elm_lang$core$Native_Utils.update(
					model,
					{value: _p2, animation: newAnimation});
			case 'Tick':
				return _elm_lang$core$Native_Utils.update(
					model,
					{clock: _p1._0});
...
var _user$project$Bar$init = F2(
	function (value, horizontal) {
		return {
			value: value,
			duration: 1 * _elm_lang$core$Time$second,
			clock: 0,
			boxAttributes: _elm_lang$core$Native_List.fromArray(
				[]),
			sliderAttributes: _elm_lang$core$Native_List.fromArray(
				[]),
			boxClasses: _elm_lang$core$Native_List.fromArray(
				[]),
			sliderClasses: _elm_lang$core$Native_List.fromArray(
				[]),
			animation: _mgold$elm_animation$Animation$static(value),
			horizontal: horizontal
		};
	});
var _user$project$Bar$Model = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {value: a, duration: b, clock: c, animation: d, boxAttributes: e, sliderAttributes: f, horizontal: g, sliderClasses: h, boxClasses: i};
	});
var _user$project$Bar$Duration = function (a) {
	return {ctor: 'Duration', _0: a};
};
var _user$project$Bar$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$Bar$subscriptions = function (model) {
...
var _user$project$Wordbank$view = function (model) {
	var wordbank = A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$id('wordbank')
			]),
		A2(
			_elm_lang$core$List$take,
			model.maxToDisplay,
			A2(_elm_lang$core$List$filterMap, _user$project$Wordbank$viewWord, model.words)));
	return wordbank;
};
var _user$project$Wordbank$toggleWord = F3(
...
var _user$project$Wordbank$toggleWords = F2(
...
var _user$project$Wordbank$init = F2(
	function (words, maxToDisplay) {
		return {
			words: A2(
				_elm_lang$core$List$map,
				function (x) {
...
var _user$project$Wordbank$Remove = function (a) {
	return {ctor: 'Remove', _0: a};
};
var _user$project$Wordbank$Add = function (a) {
	return {ctor: 'Add', _0: a};
};
var _user$project$Wordbank$ShowAll = {ctor: 'ShowAll'};
var _user$project$Wordbank$HideAll = {ctor: 'HideAll'};
var _user$project$Wordbank$Toggle = function (a) {
	return {ctor: 'Toggle', _0: a};
};
var _user$project$Wordbank$Show = function (a) {
	return {ctor: 'Show', _0: a};
};
var _user$project$Wordbank$Hide = function (a) {
	return {ctor: 'Hide', _0: a};
};
var _user$project$Wordbank$Flip = {ctor: 'Flip'};
var _user$project$Wordbank$Off = {ctor: 'Off'};
		...
		switch (_p13.ctor) {
			...
			case 'HideAll':
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						words: A2(_user$project$Wordbank$toggleWords, _user$project$Wordbank$Off, model.words)
					});
			case 'ShowAll':
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						words: A2(_user$project$Wordbank$toggleWords, _user$project$Wordbank$On, model.words)
					});
			case 'Add':
				return _elm_lang$core$Native_Utils.update(
					model,
...
var _user$project$Loadout_Loadout$viewWord = F3(
	function (word, load, select) {
		var tagSelect = select ? ' selected' : '';
		var tagLoad = load ? ' loaded' : ' unloaded';
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					...
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							word.partOfSpeech,
							A2(_elm_lang$core$Basics_ops['++'], tagLoad, tagSelect))))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
...
var _user$project$Loadout_Loadout$keycode = {enter: 13, shift: 16, space: 32, escape: 27, left: 106, up: 105, right: 108, down: 107};
var _user$project$Loadout_Loadout$getBeforeAfter = F3(
	function (predicate, list, backup) {
		var _p0 = A2(_elm_community$list_extra$List_Extra$span, predicate, list);
		var x = _p0._0;
		var y = _p0._1;
		var before = function () {
			var _p1 = _elm_community$list_extra$List_Extra$last(
				A2(_elm_lang$core$Basics_ops['++'], y, x));
			if (_p1.ctor === 'Just') {
				return _p1._0;
			} else {
				return backup;
		...
		return {ctor: '_Tuple2', _0: before, _1: after};
	});
var _user$project$Loadout_Loadout$getPosCapacity = F2(
	function (model, thisPos) {
		return _elm_lang$core$Basics$snd(
			A2(
				_elm_lang$core$Maybe$withDefault,
				{ctor: '_Tuple2', _0: 'null', _1: 100},
				_elm_lang$core$List$head(
					A2(
						_elm_lang$core$List$filter,
						function (_p3) {
							var _p4 = _p3;
							return _elm_lang$core$Native_Utils.eq(_p4._0, thisPos);
						},
						model.capacity))));
	});
var _user$project$Loadout_Loadout$nullWord = {word: 'null', partOfSpeech: 'Noun', tag: 'nullWordTag'};
var _user$project$Loadout_Loadout$sortWordsTuple = function (words) {
	return A2(
		...
		A2(
			...
			function (_p5) {
				var _p6 = _p5;
				return A2(_elm_community$list_extra$List_Extra$getAt, _p6._1, words);
			},
			_elm_lang$core$List$sort(
				A2(
					...
					F2(
						function (i, _p7) {
							var _p8 = _p7;
							return {ctor: '_Tuple2', _0: _p8._0.word, _1: i};
						}),
					words))));
};
var _user$project$Loadout_Loadout$viewPOS = F2(
	function (pos, model) {
		var posIndex = function () {
			var _p9 = A2(_elm_community$list_extra$List_Extra$elemIndex, pos, model.partsOfSpeech);
			if (_p9.ctor === 'Just') {
				return _elm_lang$core$Basics$toString(_p9._0 + 1);
			} else {
				return '0';
			}
		}();
		var used = _elm_lang$core$List$length(
			A2(
				_elm_lang$core$List$filter,
				function (w) {
					return _elm_lang$core$Native_Utils.eq(w.partOfSpeech, pos);
				},
				model.loaded));
		var capacity = A2(_user$project$Loadout_Loadout$getPosCapacity, model, pos);
		var capacityDiv = A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('capacity')
				]),
			A2(
				_elm_lang$core$Basics_ops['++'],
				A2(
					...
					A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('led used')
							]),
						_elm_lang$core$Native_List.fromArray(
							[]))),
				A2(
					...
					A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('led unused')
							]),
						_elm_lang$core$Native_List.fromArray(
							[])))));
		var headingDiv = A2(
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$String$toLower(pos))
						])),
					capacityDiv
				]));
		var unloaded = A2(
		...
		var loaded = A2(
			...
			model.loaded);
		var words = A2(_elm_lang$core$Basics_ops['++'], loaded, unloaded);
		var wordsWithPOS = _user$project$Loadout_Loadout$sortWordsTuple(
			A2(
				_elm_lang$core$List$filter,
				function (_p10) {
					var _p11 = _p10;
					return _elm_lang$core$Native_Utils.eq(_p11._0.partOfSpeech, pos);
				},
				words));
		...
		var wordsDiv = A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('words')
				]),
			A2(
				_elm_lang$core$Basics_ops['++'],
				A2(
					...
					function (_p12) {
						...
						var _p14 = _p13._0;
						return A3(
							_user$project$Loadout_Loadout$viewWord,
							_p14,
							_p13._1,
							_elm_lang$core$Native_Utils.eq(_p14, selected));
					},
					wordsWithPOS),
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('scroll-dummy')
							]),
						_elm_lang$core$Native_List.fromArray(
							[]))
					])));
				...
				[
					...
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							pos,
							A2(_elm_lang$core$Basics_ops['++'], ' pos-', posIndex))))
				]),
			_elm_lang$core$Native_List.fromArray(
				[headingDiv, wordsDiv]));
	});
var _user$project$Loadout_Loadout$view = function (model) {
	var divPOS = A2(
		_elm_lang$core$List$map,
		function (p) {
			return A2(_user$project$Loadout_Loadout$viewPOS, p, model);
		},
		model.partsOfSpeech);
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$id('loadout')
			]),
		divPOS);
};
var _user$project$Loadout_Loadout$sortWords = function (words) {
	return A2(
...
var _user$project$Loadout_Loadout$initFromLongform = function (words) {
	var partsOfSpeech = _elm_community$list_extra$List_Extra$unique(
		A2(
			_elm_lang$core$List$map,
			function (_p15) {
				var _p16 = _p15;
			...
			words));
	var convert = F2(
		function (predicate, words) {
			return A2(
				_elm_lang$core$List$map,
				function (_p17) {
					var _p18 = _p17;
					return {word: _p18._1, partOfSpeech: _p18._0, tag: 'wordTag'};
				},
				A2(
					_elm_lang$core$List$filter,
					predicate,
	...
	var unloaded = A2(
		...
		function (_p23) {
			var _p24 = _p23;
			return _elm_lang$core$Basics$not(_p24._2);
		},
		words);
	var selected = A2(
		_elm_lang$core$Maybe$withDefault,
		_user$project$Loadout_Loadout$nullWord,
		_elm_lang$core$List$head(
			A2(
				convert,
				function (_p25) {
	...
	return {
		...
		unloaded: unloaded,
		selected: selected,
		total: _elm_lang$core$List$length(words),
...
var _user$project$Loadout_Loadout$init = F3(
	function (loaded, unloaded, capacity) {
		return {
			loaded: _user$project$Loadout_Loadout$sortWords(loaded),
			unloaded: _user$project$Loadout_Loadout$sortWords(unloaded),
			selected: A2(
				_elm_lang$core$Maybe$withDefault,
				_user$project$Loadout_Loadout$nullWord,
				_elm_lang$core$List$head(
					A2(_elm_lang$core$Basics_ops['++'], loaded, unloaded))),
			total: _elm_lang$core$List$length(
				A2(_elm_lang$core$Basics_ops['++'], loaded, unloaded)),
			partsOfSpeech: _elm_community$list_extra$List_Extra$unique(
				A2(
					_elm_lang$core$List$map,
					function (w) {
						return w.partOfSpeech;
					},
					A2(_elm_lang$core$Basics_ops['++'], loaded, unloaded))),
			capacity: capacity,
			key: 0
...
var _user$project$Loadout_Loadout$ccc = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple3', _0: 'Adjective', _1: 'Fuckers', _2: false},
		{ctor: '_Tuple3', _0: 'Noun', _1: 'You', _2: false},
		{ctor: '_Tuple3', _0: 'Adjective', _1: 'Hello', _2: true},
		{ctor: '_Tuple3', _0: 'Noun', _1: 'There', _2: true}
	]);
var _user$project$Loadout_Loadout$aaa = _elm_lang$core$Native_List.fromArray(
	[
		{word: 'Hello', partOfSpeech: 'Adjective'},
		{word: 'There', partOfSpeech: 'Noun'}
	]);
var _user$project$Loadout_Loadout$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {loaded: a, unloaded: b, selected: c, total: d, partsOfSpeech: e, key: f, capacity: g};
	});
var _user$project$Loadout_Loadout$KeyPress = function (a) {
	return {ctor: 'KeyPress', _0: a};
};
var _user$project$Loadout_Loadout$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$keyboard$Keyboard$presses(_user$project$Loadout_Loadout$KeyPress)
			]));
};
var _user$project$Loadout_Loadout$Select = {ctor: 'Select'};
var _user$project$Loadout_Loadout$update = F2(
	function (msg, model) {
		update:
		while (true) {
			var _p27 = msg;
			if (_p27.ctor === 'KeyPress') {
				var _p31 = _p27._0;
				var posWords = function (pos) {
					return _user$project$Loadout_Loadout$sortWords(
						A2(
							_elm_lang$core$List$filter,
							function (w) {
								return _elm_lang$core$Native_Utils.eq(w.partOfSpeech, pos);
							},
							A2(_elm_lang$core$Basics_ops['++'], model.loaded, model.unloaded)));
				};
				var getWord = function (pos) {
					var _p28 = _elm_lang$core$List$head(
						posWords(pos));
					if (_p28.ctor === 'Just') {
						return _p28._0;
					} else {
				...
				var thisPos = model.selected.partOfSpeech;
				var _p29 = A3(
					_user$project$Loadout_Loadout$getBeforeAfter,
					function (w) {
						return !_elm_lang$core$Native_Utils.eq(w, model.selected);
					},
					posWords(thisPos),
					model.selected);
				var up = _p29._0;
				...
				var _p30 = A3(
					_user$project$Loadout_Loadout$getBeforeAfter,
					function (pos) {
						return !_elm_lang$core$Native_Utils.eq(pos, thisPos);
					},
					model.partsOfSpeech,
					thisPos);
				var before = _p30._0;
				var after = _p30._1;
				var left = getWord(before);
				var right = getWord(after);
				if (_elm_lang$core$Native_Utils.eq(_p31, _user$project$Loadout_Loadout$keycode.up)) {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
					...
					if (_elm_lang$core$Native_Utils.eq(_p31, _user$project$Loadout_Loadout$keycode.down)) {
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								model,
						...
						if (_elm_lang$core$Native_Utils.eq(_p31, _user$project$Loadout_Loadout$keycode.left)) {
							return A2(
								_elm_lang$core$Platform_Cmd_ops['!'],
								_elm_lang$core$Native_Utils.update(
									model,
							...
							if (_elm_lang$core$Native_Utils.eq(_p31, _user$project$Loadout_Loadout$keycode.right)) {
								return A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
									_elm_lang$core$Native_Utils.update(
										model,
								...
								if (_elm_lang$core$Native_Utils.eq(_p31, 115)) {
									var _v16 = _user$project$Loadout_Loadout$Select,
										_v17 = model;
									msg = _v16;
									model = _v17;
									continue update;
				...
				var _p32 = A2(_elm_lang$core$List$member, model.selected, model.loaded) ? {
					ctor: '_Tuple2',
					_0: A2(_elm_community$list_extra$List_Extra$remove, model.selected, model.loaded),
					_1: _user$project$Loadout_Loadout$sortWords(
						A2(
							_elm_lang$core$Basics_ops['++'],
							model.unloaded,
							_elm_lang$core$Native_List.fromArray(
					...
					ctor: '_Tuple2',
					_0: _user$project$Loadout_Loadout$sortWords(
						A2(
							_elm_lang$core$Basics_ops['++'],
							model.loaded,
							_elm_lang$core$Native_List.fromArray(
								[model.selected]))),
					_1: A2(_elm_community$list_extra$List_Extra$remove, model.selected, model.unloaded)
				};
				var newLoaded = _p32._0;
				var newUnloaded = _p32._1;
				var thisPos = model.selected.partOfSpeech;
				var capacity = A2(_user$project$Loadout_Loadout$getPosCapacity, model, thisPos);
				var used = _elm_lang$core$List$length(
					A2(
						_elm_lang$core$List$filter,
						function (w) {
							return _elm_lang$core$Native_Utils.eq(w.partOfSpeech, thisPos);
						},
						model.loaded));
				return (A2(_elm_lang$core$List$member, model.selected, model.unloaded) && _elm_lang$core$Native_Utils.eq(used, capacity)) ? A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model,
					_elm_lang$core$Native_List.fromArray(
						[])) : A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{loaded: newLoaded, unloaded: newUnloaded}),
					_elm_lang$core$Native_List.fromArray(
						[]));
			}
		}
	});
var _user$project$Loadout_Loadout$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				_user$project$Loadout_Loadout$initFromLongform(_user$project$Loadout_Loadout$ccc),
				_elm_lang$core$Native_List.fromArray(
					[])),
			update: _user$project$Loadout_Loadout$update,
			view: _user$project$Loadout_Loadout$view,
			subscriptions: _user$project$Loadout_Loadout$subscriptions
		})
};
...
var _user$project$Versus$viewRemark = function (remark) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('remark')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('insult')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(remark.insult)
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('retort')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(remark.retort)
					]))
			]));
};
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('insult-phrase')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(remark.insult)
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('insult-score')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(
								_elm_lang$core$Basics$toString(remark.score))
							]))
					])),
				A2(
				_elm_lang$html$Html$div,
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('retort-score')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('retort-phrase')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(remark.retort)
	...
	var statusEnemy = A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(model.enemyImage)
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$id('top-half')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('enemy')
							]),
						_elm_lang$core$Native_List.fromArray(
							[statusEnemy, enemy])),
						A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$id('bottom-half')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$id('bottom-left')
							]),
						_elm_lang$core$Native_List.fromArray(
							[addInput, wordbank])),
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$id('bottom-right')
							]),
						_elm_lang$core$Native_List.fromArray(
							[output]))
					]))
...
var _user$project$Map_View$view = function (model) {
	var keyAtt = A2(
		_elm_lang$html$Html_Attributes$attribute,
		'key',
		_elm_lang$core$Basics$toString(model.key));
		...
		switch (_p0.ctor) {
			case 'MenuOverlay':
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$id('overlay')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
			...
			case 'EncounterOverlay':
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$id('encounter')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
			...
			default:
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$id('empty-overlay')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
...
var _user$project$Map$tilesWeapons = _elm_lang$core$Native_List.fromArray(
	[
		{
		label: ': gun',
...
var _user$project$Map$tiles = _elm_lang$core$Native_List.fromArray(
	[
		...
		{
		label: ': weapons',
		key: _elm_lang$core$Native_Utils.chr('w'),
		id: 'w',
		x: 0,
		y: 0
	}
...
var _user$project$Map$initLoadout = function (player) {
	return A3(_user$project$Loadout_Loadout$init, player.loaded, player.unloaded, player.capacity);
};
var _user$project$Map$initLoadoutLongform = function (longform) {
	return _user$project$Loadout_Loadout$initFromLongform(longform);
};
var _user$project$Map$initWeapons = A2(_user$project$Menu_Menu$init, _user$project$Map$tilesWeapons, 'my-menu');
var _user$project$Map$initMenu = A2(_user$project$Menu_Menu$init, _user$project$Map$tiles, 'my-menu');
var _user$project$Map$updatePlayer = _elm_lang$core$Native_Platform.outgoingPort(
	'updatePlayer',
	function (v) {
		return {
			loaded: _elm_lang$core$Native_List.toArray(v.loaded).map(
				function (v) {
					return {word: v.word, partOfSpeech: v.partOfSpeech, tag: v.tag};
				}),
			unloaded: _elm_lang$core$Native_List.toArray(v.unloaded).map(
				function (v) {
					return {word: v.word, partOfSpeech: v.partOfSpeech, tag: v.tag};
				}),
			capacity: _elm_lang$core$Native_List.toArray(v.capacity).map(
				function (v) {
					return [v._0, v._1];
				})
		};
...
var _user$project$Map$requestEncounter = _elm_lang$core$Native_Platform.outgoingPort(
	...
	function (v) {
		return [
			v._0,
			{
			loaded: _elm_lang$core$Native_List.toArray(v._1.loaded).map(
				function (v) {
					return {word: v.word, partOfSpeech: v.partOfSpeech, tag: v.tag};
				}),
			unloaded: _elm_lang$core$Native_List.toArray(v._1.unloaded).map(
				function (v) {
					return {word: v.word, partOfSpeech: v.partOfSpeech, tag: v.tag};
				}),
			capacity: _elm_lang$core$Native_List.toArray(v._1.capacity).map(
				function (v) {
					return [v._0, v._1];
				})
		}
		...
		while (true) {
			...
			switch (_p0.ctor) {
				case 'UpdateEncounter':
					var _p1 = A2(_user$project$Versus$update, _p0._0, model.encounter);
					var newEncounter = _p1._0;
					var newMsg = _p1._1;
				...
				case 'UpdateLoadout':
					if (!_elm_lang$core$Native_Utils.eq(model.overlay, _user$project$Map_Types$LoadoutOverlay)) {
						...
						var _p2 = A2(_user$project$Loadout_Loadout$update, _p0._0, model.loadout);
				...
				case 'UpdateWeapons':
					if (!_elm_lang$core$Native_Utils.eq(model.overlay, _user$project$Map_Types$WeaponsOverlay)) {
						...
						var _p4 = A2(_user$project$Menu_Menu$update, _p0._0, model.weapons);
						var newWeapons = _p4._0;
				...
				case 'UpdateMenu':
					if (!_elm_lang$core$Native_Utils.eq(model.overlay, _user$project$Map_Types$MenuOverlay)) {
						...
						var _p6 = A2(_user$project$Menu_Menu$update, _p0._0, model.menu);
						var newMenu = _p6._0;
				...
				case 'UpdateMapMenu':
					if (!_elm_lang$core$Native_Utils.eq(model.overlay, _user$project$Map_Types$NoOverlay)) {
						...
						var _p8 = A2(_user$project$Menu_Menu$update, _p0._0, model.mapMenu);
						var newMapMenu = _p8._0;
						var selection = _p8._1;
						var _p9 = selection;
						if (_p9.ctor === 'Nothing') {
							return A2(
								_elm_lang$core$Platform_Cmd_ops['!'],
						...
						case 'NoOverlay':
							return A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[]));
						case 'EncounterOverlay':
							var place = _elm_lang$core$List$head(
								A2(
									_elm_lang$core$List$filter,
									function (p) {
										return _elm_lang$core$Native_Utils.eq(
											p.label,
											_elm_lang$core$String$fromChar(_p10._0));
									},
									model.map.places));
							var _p11 = place;
							if (_p11.ctor === 'Nothing') {
								...
								return {
									...
									_0: _elm_lang$core$Native_Utils.update(
										model,
										{overlay: _p12, encounter: _user$project$Map$initEncounter}),
									_1: _elm_lang$core$Platform_Cmd$batch(
										_elm_lang$core$Native_List.fromArray(
											[
												_user$project$Map$requestEncounter(
												{ctor: '_Tuple2', _0: _p11._0.enemy, _1: model.player}),
						...
						case 'LoadoutOverlay':
							return A2(
								...
								_elm_lang$core$Native_Utils.update(
									...
									{
										overlay: _p12,
										loadout: _user$project$Map$initLoadout(model.player)
									}),
								_elm_lang$core$Native_List.fromArray(
									[]));
						case 'WeaponsOverlay':
							return A2(
								...
								_elm_lang$core$Native_Utils.update(
									model,
									{overlay: _p12, weapons: _user$project$Map$initWeapons}),
								_elm_lang$core$Native_List.fromArray(
									[]));
						default:
							return A2(
								...
								_elm_lang$core$Native_Utils.update(
									model,
									{overlay: _p12, menu: _user$project$Map$initMenu}),
								_elm_lang$core$Native_List.fromArray(
									[]));
					}
				case 'KeyPress':
					...
					if (_elm_lang$core$Native_Utils.eq(
						...
						var _p13 = model.overlay;
						if (_p13.ctor === 'NoOverlay') {
							return A2(
								_elm_lang$core$Platform_Cmd_ops['!'],
								_elm_lang$core$Native_Utils.update(
									model,
				...
				case 'SetMap':
					...
					var placeToLabel = function (place) {
						var key = function () {
							var _p15 = _elm_lang$core$String$uncons(place.label);
							if (_p15.ctor === 'Just') {
								return _p15._0._0;
							} else {
						...
						return {label: place.enemy, key: key, id: place.label, x: place.x, y: place.y};
					};
					var tiles = A2(_elm_lang$core$List$map, placeToLabel, _p16.places);
					var mapMenu = A2(_user$project$Menu_Menu$init, tiles, 'map-menu');
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{map: _p16, mapMenu: mapMenu}),
						_elm_lang$core$Native_List.fromArray(
							[]));
				case 'SetPlayer':
					return A2(
...
var _user$project$Map$init = function () {
	...
	var model = {
		...
		loadout: _user$project$Map$initLoadout(player),
		encounter: _user$project$Map$initEncounter,
		weapons: _user$project$Map$initWeapons,
									...
									function (y) {
										return A2(
											...
											function (label) {
												return A2(
													_elm_lang$core$Json_Decode$andThen,
													A2(_elm_lang$core$Json_Decode_ops[':='], 'enemy', _elm_lang$core$Json_Decode$string),
													function (enemy) {
														return _elm_lang$core$Json_Decode$succeed(
															{x: x, y: y, label: label, enemy: enemy});
													});
											});
									});
							}))),
...
var _user$project$Map$setPlayer = _elm_lang$core$Native_Platform.incomingPort(
	'setPlayer',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		A2(
			...
			return A2(
				...
				function (unloaded) {
					return A2(
						...
						function (capacity) {
							return _elm_lang$core$Json_Decode$succeed(
								{loaded: loaded, unloaded: unloaded, capacity: capacity});
						});
				});
		}));
...
var Elm = {};
Elm['Map'] = Elm['Map'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Map'], 'Map', typeof _user$project$Map$main === 'undefined' ? null : _user$project$Map$main);
